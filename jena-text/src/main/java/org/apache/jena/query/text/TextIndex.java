...
public interface TextIndex extends Closeable //, Transactional 
{
    ...
    List<TextHit> query(List<Resource> property, String qs, String graphURI, String lang, int limit, String highlight) ;
    
    List<TextHit> query(String subjectUri, List<Resource> property, String qs, String graphURI, String lang, int limit, String highlight);
